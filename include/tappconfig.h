...
public:
  ...
  void setValue(const tstring &par, TACO_SET_IN setin, bool verbose = false,
                const tstring &env = "", const tstring &rcfile = "",
...
private:
  ...
  tstring getWasSetStr(TACO_SET_IN setin, const tstring &env,
                       const tstring &rcfile) const;
...
public:
  // ctor & dtor
  TAppConfig(const char *conflist[], const char *listname, int argc, char *av[],
             const char *envstrname, const char *rcname,
...
private:
  ...
  void setFromStr(const tstring &str, const tstring &context,
                  TAppConfigItem::TACO_SET_IN setin);
  tstring getName(const tstring &str, const tstring &context,
                  const tstring &optprefix = "",
                  bool errorIfNotFound = true) const;
