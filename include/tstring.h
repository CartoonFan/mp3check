...
private:
    ...
    public:
        ...
        char *data() {
            return (char *)(this + 1);   // 'this + 1' means 'the byte following this object'
        }
        // character access
...
public:
    ...
    {
        if(scanner >= rep->len) return true;
        else return false;
    }
    ...
    char lastChar() const {
        return rep->len?(*rep)[rep->len-1]:0;
    }
